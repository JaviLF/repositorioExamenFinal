...
INSERT INTO user_profile (id,comment_count,name) VALUES (1,0,'Pasivo');
INSERT INTO user_profile (id,comment_count,name) VALUES (2,1,'Activo');
INSERT INTO user_profile (id,comment_count,name) VALUES (3,5,'Comentador');
INSERT INTO user_profile (id,comment_count,name) VALUES (4,100,'Gran comentador');

INSERT INTO user (id,admin,name,last_name,password,username,city_id,user_profile_id) VALUES (1,1,'Grillo','Pepe','$2a$10$QVUYllnp1PMD4aQN/TDese/L78dN0ABWhnolJl0xmMtmTt.7ajx72','a',50,1);
INSERT INTO user (id,admin,name,last_name,password,username,city_id,user_profile_id) VALUES (2,0,'ElHonrado','Juan','$2a$10$QVUYllnp1PMD4aQN/TDese/L78dN0ABWhnolJl0xmMtmTt.7ajx72','aa',57,1);
